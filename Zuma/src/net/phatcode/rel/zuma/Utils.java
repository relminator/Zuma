...
public class Utils
{
	...
	public static int getHours( int secondsElapsed )
	{
		
		return secondsElapsed / (60*60);
	}
	
	public static int getMinutes( int secondsElapsed )
	{
	...
	public static int getSeconds( int secondsElapsed )
	{
